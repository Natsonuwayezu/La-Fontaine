// ══════════════════════════════════════════════════════════════════════════
        ...
        const NAV_CONFIG = {
            ...
            admin: [
                ...
                {
                    section: '⚙️ Settings & Configuration', items: [
            ...
            // ── ACCOUNTANT: Finance + Attendance (Full) ──────────────
            accountant: [
                {
                    section: '🏠 Dashboard', items: [
         ...
         */
        function findNavLabel(id, role) { const navConfig = { admin: [{ id: 'admin-dashboard', label: 'Dashboard' }, { id: 'analytics', label: 'Analytics' }, { id: 'announcements', label: 'Announcements' }, { id: 'notification-center', label: 'Notification Center' }, { id: 'reminders', label: 'Reminders' }, { id: 'attendance', label: 'Attendance' }, { id: 'attendance-reports', label: 'Attendance Reports' }, { id: 'attendance-summary', label: 'Attendance Summary' }, { id: 'attendance-analytics', label: 'Attendance Analytics' }, { id: 'student-list', label: 'Students' }, { id: 'enroll-student', label: 'Enroll Student' }, { id: 'student-details', label: 'Student Details' }, { id: 'family-management', label: 'Family Management' }, { id: 'student-promotion', label: 'Student Promotion' }, { id: 'student-archive', label: 'Student Archive' }, { id: 'marks-entry', label: 'Marks Entry' }, { id: 'marks-database', label: 'Marks Database' }, { id: 'class-register', label: 'Class Register' }, { id: 'report-cards', label: 'Report Cards' }, { id: 'transcripts', label: 'Transcripts' }, { id: 'academic-reports', label: 'Academic Reports' }, { id: 'statistics', label: 'Statistics' }, { id: 'finance-dashboard', label: 'Finance Dashboard' }, { id: 'fee-structure', label: 'Fee Structure' }, { id: 'record-payment', label: 'Record Payment' }, { id: 'payment-history', label: 'Payment History' }, { id: 'receipt-printing', label: 'Receipts & Printing' }, { id: 'overdue-payments', label: 'Overdue Payments' }, { id: 'fee-waivers', label: 'Fee Waivers' }, { id: 'balances', label: 'Balances' }, { id: 'payment-reversals', label: 'Payment Reversals' }, { id: 'financial-reports', label: 'Financial Reports' }, { id: 'fee-term-status', label: 'Fee Term Status' }, { id: 'carry-forward', label: 'Carry Forward' }, { id: 'student-fee-status', label: 'Student Fee Status' }, { id: 'family-fee-summary', label: 'Family Fee Summary' }, { id: 'user-management', label: 'Staff Management' }, { id: 'subjects', label: 'Subjects' }, { id: 'teacher-assignments', label: 'Teacher Assignments' }, { id: 'teacher-performance', label: 'Teacher Performance' }, { id: 'timetable', label: 'Timetable' }, { id: 'school-settings', label: 'School Settings' }, { id: 'academic-calendar', label: 'Academic Calendar' }, { id: 'academic-years', label: 'Academic Years' }, { id: 'class-management', label: 'Class Management' }, { id: 'grading-scale', label: 'Grading Scale' }, { id: 'backup-restore', label: 'Backup & Restore' }, { id: 'system-logs', label: 'System Logs' }, { id: 'api-settings', label: 'API Settings' }, { id: 'settings', label: 'Settings' }, { id: 'bulk-import', label: 'Bulk Import' }, { id: 'bulk-export', label: 'Bulk Export' }], teacher: [{ id: 'teacher-dashboard', label: 'Dashboard' }, { id: 'notifications', label: 'Notifications' }, { id: 'marks-entry', label: 'Marks Entry' }, { id: 'marks-database', label: 'Marks Database' }, { id: 'class-register', label: 'Class Register' }, { id: 'report-cards', label: 'Report Cards' }, { id: 'statistics', label: 'Statistics' }, { id: 'student-list', label: 'Students' }, { id: 'student-details', label: 'Student Details' }, { id: 'attendance', label: 'Attendance' }, { id: 'attendance-reports', label: 'Attendance Reports' }, { id: 'teacher-timetable', label: 'My Timetable' }], accountant: [{ id: 'accountant-dashboard', label: 'Dashboard' }, { id: 'notifications', label: 'Notifications' }, { id: 'attendance', label: 'Attendance' }, { id: 'attendance-reports', label: 'Attendance Reports' }, { id: 'attendance-summary', label: 'Attendance Summary' }, { id: 'attendance-analytics', label: 'Attendance Analytics' }, { id: 'student-list', label: 'Students' }, { id: 'student-details', label: 'Student Details' }, { id: 'student-fees', label: 'Student Fees' }, { id: 'fee-structure', label: 'Fee Structure' }, { id: 'record-payment', label: 'Record Payment' }, { id: 'payment-history', label: 'Payment History' }, { id: 'receipt-printing', label: 'Receipts' }, { id: 'overdue-payments', label: 'Overdue Payments' }, { id: 'fee-waivers', label: 'Fee Waivers' }, { id: 'balances', label: 'Balances' }, { id: 'payment-reversals', label: 'Payment Reversals' }, { id: 'financial-reports', label: 'Financial Reports' }, { id: 'fee-term-status', label: 'Fee Term Status' }, { id: 'carry-forward', label: 'Carry Forward' }, { id: 'student-fee-status', label: 'Student Fee Status' }, { id: 'family-fee-summary', label: 'Family Fee Summary' }] }; const config = navConfig[role] || []; for (const item of config) { if (item.id === id) return item.label; } return id; }
        /**
